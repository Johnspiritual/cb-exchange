        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold text-gray-900">CB Exchange</span>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index}>
                  <Link href={link.href} className="text-gray-700 hover:text-black transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">Lagos, Nigeria & Ho Chi Minh, Vietnam</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@cbexchange.com" className="text-gray-700 hover:text-black transition-colors">
                  info@cbexchange.com
                </a>
              </li>
              <li className="pt-4">
                <a
                  href="https://wa.me/2348101229792"
                  target="_blank"
